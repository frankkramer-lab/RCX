...
#' @param ignoreNA logical (default=T); ignore NA values
#' @param verbose logical (default=F); also log the results
...
.test_RequiredColumnsPresent = function(aspect, columns, verbose=F){
...
.test_ListRequiredColumnsPresent = function(aspect, columns, verbose=F){
...
.test_AllowedColumnsPresent = function(aspect, columns, verbose=F){
...
.test_ListAllowedColumnsPresent = function(aspect, columns, verbose=F){
    pass = all(colnames(aspect) %in% columns)
    if(verbose) .log(paste0("- Only allowed columns present (",.pasteC(columns),")"), pass)
    return(pass)
}
...
.test_NoMergeColumn = function(aspect, column, verbose=F){
...
.test_AtLeastOneColumnPresent = function(aspect, columns, verbose=F){
...
.test_AtLeastOneElementPresent = function(aspect, element, verbose=F){
...
.test_OneNodePresent = function(nodesAspect, column, verbose=F){
...
.test_IsUnique = function(aspect, column, verbose=F){
...
.test_ListAllUnique = function(aspect, column, verbose=F){
...
#' @describeIn dot_test checks if all elements in specified column are unique
.test_IsUniqueInLists = function(aspect, column, verbose=F){
...
#' @describeIn dot_test checks if all elements in specified column are unique
.test_ListAllUniqueInLists = function(aspect, column, verbose=F){
...
.test_IsLogical = function(aspect, column, verbose=F){
...
.test_IsNumeric = function(aspect, column, verbose=F){
...
#' @describeIn dot_test checks if the specified column is of type numeric
.test_ElementIsNumeric = function(aspect, element, verbose=F){
...
.test_IsCharacter = function(aspect, column, verbose=F){
...
.test_ListAllCharacter = function(aspect, element, verbose=F){
...
.test_IsList = function(aspect, column, verbose=F){
...
#' @describeIn dot_test checks if the specified column is of type list
.test_ElementIsList = function(aspect, element, verbose=F){
...
.test_IsPos = function(aspect, column, verbose=F){
...
.test_IsClass = function(x, cls, verbose=F){
...
.test_IsNamedList = function(aspect, names, verbose=F){
    pass = is.list(aspect)
...
.test_IsCVPclass = function(x, cls, verbose=F){
...
.test_ListOfCVPclass = function(x, cls, verbose=F){
...
.test_ContainsNA = function(aspect, column, verbose=F){
...
.test_ListAllContainsNA = function(aspect, element, verbose=F){
...
.test_ListAllNumeric = function(aspect, column, verbose=F){
...
#' @describeIn dot_test checks if the specified column is a list with only numeric values (NAs and NULLs are not considered) or in .DICT
.test_ListAllOfClass = function(aspect, cls, verbose=F){
...
.test_AspectExist = function(rcx, aspect, verbose=F){
...
.test_IdsInAspect = function(ids, aspect, column, info="", verbose=F){
...
.test_ValuesInSet = function(aspect, column, set, ignoreNA=T, verbose=F){
...
.test_DataTypeColumn = function(aspect, column, verbose=F){
